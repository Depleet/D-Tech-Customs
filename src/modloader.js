exports.mod = (mod_data) => {
    logger.logInfo("[MOD] D-Tech Customs Collection");
	...
	// to read all files/folders in specified directory use global.fileIO.readDir(path)
	...
	logger.logSuccess("[MOD] D-Tech Customs Collection; Applied");
}